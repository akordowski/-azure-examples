...
gh secret set REGISTRY_LOGIN_SERVER --body "$CONTAINER_REGISTRY_LOGIN_SERVER"
gh secret set REGISTRY_USERNAME --body "$CLIENT_ID"
gh secret set REGISTRY_PASSWORD --body "$CLIENT_SECRET"
